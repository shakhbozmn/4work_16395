...
from .models import Category, Project, Application
...
class ApplicationAdmin(admin.ModelAdmin):
    list_display = ['project', 'freelancer', 'status', 'proposed_timeline', 'created_at']
    ...
    fieldsets = (
        ...
        ('Proposal', {'fields': ('cover_letter', 'proposed_timeline', 'proposed_budget')}),
        ('Timestamps', {'fields': ('created_at', 'updated_at')}),
    )
